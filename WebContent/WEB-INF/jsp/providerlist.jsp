...
<c:if test="${getProviderList == null }">
<c:redirect url="/user/providerlist.html"></c:redirect>
</c:if>
<div class="right">
        <div class="location">
        ...
        <div class="search">
        	<form method="post" action="${pageContext.request.contextPath }/user/providerlist.html">
				...
				<a href="${pageContext.request.contextPath }/Role/provideradd.html">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${getProviderList }" varStatus="status">
				<tr>
					<td>
